            ...
            <div>
                ...
                <div class="mt-6 flex justify-between space-x-8">
                    ...
                    <div class="flex text-sm">
                        <a href="#" class="inline-flex items-center space-x-2 text-gray-400 hover:text-gray-500">
                            <span class="font-medium text-gray-900">See more</span>
                        </a>
                    </div>
                </div>
                <div class="mt-8">
        <h3 class="text-lg font-medium text-gray-900">Commentators</h3>
        <ul class="mt-4 space-y-4">
          <li class="flex space-x-4">
            <img class="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde" alt="Commentator 1">
            <div>
              <p class="text-sm font-medium text-gray-900">John Doe</p>
              <p class="text-sm text-gray-500">This was a fascinating insight! Thank you for sharing.</p>
            </div>
          </li>
          <li class="flex space-x-4">
            <img class="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2" alt="Commentator 2">
            <div>
              <p class="text-sm font-medium text-gray-900">Jane Smith</p>
              <p class="text-sm text-gray-500">I think AlpineJS would be a great choice here.</p>
            </div>
          </li>
        </ul>
      </div>
