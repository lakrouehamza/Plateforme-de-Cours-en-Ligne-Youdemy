                  ...
                  <table class="table-auto min-w-full rounded-xl">
                      <thead>
                          <tr class="bg-gray-50">
                              ...
                              <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Full Name </th>
                              ...
                              <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> email </th>
                      ...
                      <tbody class="divide-y divide-gray-300 ">
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                              ...
                              <div class="w-48 flex items-center gap-3">
                                      ...
                                      <div class="data">
                                          <p class="font-normal  text-gray-900">Floyd Miles</p>
                                      </div>
                                  </div>
                              </td>
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> sted </td>
                              <td class=" px-5 py-3">
                                  2002-20-2
                              </td>
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">ewpma@gmail.com </td> 
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
